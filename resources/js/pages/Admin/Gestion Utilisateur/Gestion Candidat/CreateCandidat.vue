      ...
      <div class="mt-3">
        <form @submit.prevent="submitCreate">
          ...
          <div class="mb-3">
            ...
            <input type="text" v-model="form.first_name" id="first_name" placeholder="Candidat First Name"
              class="form-control" required>
          </div>
          <div class="mb-3">
            <label for="last_name" class="form-label">Last Name :</label>
            <input type="text" v-model="form.last_name" id="last_name" placeholder="Candidat Last Name"
              class="form-control" required>
          </div>
          <div class="mb-3">
            <label for="email" class="form-label">Email :</label>
            <input type="email" v-model="form.email" id="email" placeholder="Candidat Email" class="form-control"
              required>
          </div>
          <div class="mb-3">
            <label for="password" class="form-label">Password :</label>
            <input type="password" v-model="form.password" id="password" placeholder="Candidat Password"
              class="form-control" required>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" v-model="form.num_tel" id="num_tel" placeholder="Candidat Phone Number"
              class="form-control">
          </div>
